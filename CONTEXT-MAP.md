...
| `packages/stores/NOTES.md`            | Tetra's TinyBase store definitions, host composition, app-specific stores, indexes, persistence, and sync boundaries.                                           |
...
- `packages/stores` describes Tetra's app data model and store host composition.
